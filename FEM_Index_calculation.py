...
def extract_nodes_and_frames():
    ...
    # 打开并加载 JSON 文件
    with open('calculate_data.json', 'r') as file:
        data = json.load(file)
    ...
    for key, value in all_data.items():
        if key.startswith('frame'):
            ...
            for i in range(len(frame_data)):
                ...
                temp1.append(frame_reactions)
                temp2.append(frame_length)
                temp3.append(section_propertie)
                #test
                ...
                #test
                al_rect_data.append(temp1)
                al_length_data.append(temp2)
                al_sect_data.append(temp3)
